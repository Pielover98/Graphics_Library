...
int main()
{
	...
	Texture face = loadTexture("../../resources/textures/face.png");
	...
	while (context.step())
	{
		...
		loc = 0, tslot = 0;
		setUniforms(s, loc, tslot, cam_proj, cam_view, modquad, face, lightPos, lightColor);
		s0_draw(f, s, quad);
	}
